-- Pinterest - User Concurrent Sessions --
...
INNER JOIN sessions AS sessions_2
  ...
  AND (sessions_2.end_time BETWEEN sessions_1.start_time AND sessions_1.end_time
   OR sessions_1.end_time BETWEEN sessions_2.start_time AND sessions_2.end_time)
